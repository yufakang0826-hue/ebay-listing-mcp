...
const DEFAULT_PROFILE_STORE_FILENAME = ".ebay-seller-profiles.json";
...
class SellerProfileStore {
  private get storePath(): string {
    return process.env.EBAY_SELLER_PROFILE_STORE || path.join(process.cwd(), DEFAULT_PROFILE_STORE_FILENAME);
  }
